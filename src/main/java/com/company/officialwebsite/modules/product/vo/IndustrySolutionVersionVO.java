...
/**
 * IndustrySolutionVersionVO：行业解决方案发布版本 VO。
 */
public class IndustrySolutionVersionVO implements Serializable {
    ...
    public IndustrySolutionVersionVO() {
    }

    public IndustrySolutionVersionVO(Long id, Long solutionId, Integer versionNo, Object snapshotJson, String snapshotHash, String changeSummary, String publisher, Long rollbackSourceVersionId, LocalDateTime publishedAt, LocalDateTime createdAt) {
        this.id = id;
