...
public class SiteConfigServiceImpl implements SiteConfigService {
    ...
    public PortalSiteConfigVO getPortalConfig() {
        ...
        PortalSiteConfigVO cached = portalCacheSupport.readCache(cacheKey, PortalSiteConfigVO.class, CACHE_SEGMENT);
        if (cached != null) {
            return cached;
        }
        ...
        portalCacheSupport.writeCache(cacheKey, vo, portalCacheSupport.isEmptyResult(vo), CACHE_SEGMENT);
        return vo;
    }
    ...
    private String portalCacheKey() {
        return portalCacheSupport.buildKey(CACHE_SEGMENT);
    }
